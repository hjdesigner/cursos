...
desafio.
*/
var teams = ['Corinthians', 'Gremio', 'Santos', 'Palmeiras', 'Flamengo'];
...
console.log( convertToHex('SteelBlue') ); //O hexadecimal para a cor SteelBlue é #4682B4.
console.log( convertToHex('Crimson') ); //O hexadecimal para a cor Crimson é #DC143C.
