(function () {
  ...
  */
  ...
  // ?
  var fullName = 'henrique-rodrigues-dos-santos-melanda';
  var newFullBame = fullName.split('-').map(function(name){
    return name[0].toUpperCase() + name.slice(1);
  }).join(' ');
  console.log(fullName);
  console.log(newFullBame);
  /*
  ...
  */
  ...
  var friends = ['Gripp', 'Maria', 'Carol', 'Dio', 'Kiss', 'Lulinha'];
